...
namespace SMG.EzRenamer
{
	public class EzRR_Rename : ScriptableObject
	{
		...
		public void Draw()
		{
			...
			EzRR_Style.DrawHelpButton("https://solomidgames.com/guides/ezRename/Rename.html");
		...
		private void DrawButtons()
		{
			...
			EzRR_Style.DrawButton("Hierarchy", DoRenameHierarchy);
			EzRR_Style.DrawButton("Project Folder", DoRenameProjectFolder);
		}
